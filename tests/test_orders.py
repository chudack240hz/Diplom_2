...
def test_create_order_with_authorization(api_client: StellarBurgersApi, registered_user, random_ingredients):
...
def test_create_order_without_authorization(api_client: StellarBurgersApi, random_ingredients):
...
def test_create_order_without_ingredients(api_client: StellarBurgersApi, registered_user):
...
def test_create_order_with_invalid_ingredient_hash(api_client: StellarBurgersApi):
