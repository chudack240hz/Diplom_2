...
def test_create_unique_user(api_client: StellarBurgersApi, unique_user_data):
...
def test_create_registered_user_fails(api_client: StellarBurgersApi, unique_user_data):
...
def test_create_user_without_required_field(api_client: StellarBurgersApi, unique_user_data):
...
def test_login_existing_user(api_client: StellarBurgersApi, registered_user):
...
def test_login_with_wrong_password(api_client: StellarBurgersApi, registered_user):
